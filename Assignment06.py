...
Jeffrey Shen, 2020-Feb-25, Created file and comments
'''
...
strFileName = 'load.txt'  # data storage file
objFile = None  # file object


class DataProcessor:
    """Processing user inputted data"""
    def user_add():
...
class FileProcessor:
    ...
    def write_file(strFileName, table):
        """Writes file data to text file

        Args:
            file name and table data
